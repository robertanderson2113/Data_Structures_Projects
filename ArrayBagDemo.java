 ...
 */
 ...
 //Modified by Robert Anderson to test the programs ability to continuously add 3 to the bag size

public final class ArrayBagDemo
{
    private static boolean arrayFull;
    ...
    public static void main(String[] args)
    {
        ...
        BagInterface<String> aBag = new ResizableArrayBag<String>(contentsOfBag.length);
        ...
        String[] contentsOfBag2 = {"A", "B", "A", "C", "B", "C", "D", "A", "B", "A", "C", "B", "C", "D", "A", "B", "A", "C", "B", "C", "D", "A", "B", "A", "C", "B", "C", "D"};
        testAdd(aBag, contentsOfBag2);

        System.out.println("Try to add another string to the full bag:");
        if (aBag.add("another string"))
            System.out.println("Successfully increased the bag's capacity: OK");
        else
 ...
 /*   Testing an initially empty bag:
        ...
        Adding A B A C B C D A B A C B C D A B A C B C D A B A C B C D
        The bag contains 22 string(s), as follows:
        A B A C B C D B A C C D A A C B D A B C B C
        Try to add another string to the full bag:
        Successfully increased the bag's capacity: OK*/