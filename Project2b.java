    ...
    public static void main(String[]args) throws IOException {
        ...
        while (inFile1.hasNextLine()) {
            for (int i = 0; i < artistArray1.length; i++) {
                ...
                artistArray1[i] = new Artist(Integer.parseInt(line[0]), line[1], "F");
        ...
        while (inFile2.hasNextLine()) {
            for (int i = 0; i < artistArrayAdd.length; i++) {
                ...
                if (line2[0].equalsIgnoreCase("D")) {
                    ...
                    artistArrayAdd[i] = new Artist(idCounter, line2[1], "F");
...
/*            for (int i = 0; i < artistList.size(); i++)
            ...
            toFile2.write(Arrays.toString(artistBag1.toArray()));
